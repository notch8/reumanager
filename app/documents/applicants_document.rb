class ApplicantsDocument
  ...
  def personal_info
    ...
    pad_bottom(10){
      ...
      pad(5) {
      text "<b>Are you a first genertion college student?</b>", :size => 14, :inline_format => true
      text "#{applicant.student}"
      }
      pad(5) {
      text "<b>Permission to share your application with other summer research programs?</b>", :size => 14, :inline_format => true
      text "#{applicant.permission_to_share}"
      }
      pad(5) {
      text "<b>Mentor Choices:</b>", :size => 14, :inline_format => true
      text "Mentor 1: #{applicant.mentor1}"
      text "Mentor 2: #{applicant.mentor2}"
      text "Mentor 3: #{applicant.mentor3}"
      }
    }
    pad_bottom(10) {
  ...
  def skills_and_experience
    ...
    pad_bottom(10) {
      ...
      pad(5) {
      text "<b>Recent Achievement</b>", :size => 14, :inline_format => true
      text "#{applicant.recent_achievement}"
      }
      pad(5) {

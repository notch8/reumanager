class ApplicantsDocument
  ...
  def personal_info
    ...
    pad_bottom(10){
      pad(5) {
      text "<b>Statement</b>", :size => 14, :inline_format => true
  ...
  def skills_and_experience
    ...
    pad_bottom(10) {
      ...
      pad(5) {
      text "<b>Please explain why you consider yourself eligible for this program as an individual from an ethnicity, background or other group that is disadvantaged and underrepresented. Please provide as much detail as possible:</b>", :size => 14, :inline_format => true
      text "#{applicant.underrepresented_eligibility}"
      }
      pad(5) {
      text "<b>Discuss your past research experiences. If you have not done any research yet, please list any relevant courses or other experiences you feel are relevant:</b>", :size => 14, :inline_format => true
      text "#{applicant.past_experience}"
      }
      pad(5) {
      text "<b>Will you receive funding from any other program throughout the summer? If 'yes', please name funding source:</b>", :size => 14, :inline_format => true
      text "#{applicant.other_funds}"
      }
    }
  end
  end
  ...
  def academic_information
    ...
    pad_bottom(10) {
      ...
      applicant.records.map do |record|
        pad_bottom(5) {
        text "<b>Academic Level:</b> #{applicant.academic_level}", :inline_format => true
        ...
        text "<b>Degree:</b> #{record.degree}", :inline_format => true

jQuery ->
  ...
  mySelect = '<select id="applicant_disability" name="applicant[disability]"><option value="Prefer to not respond">Prefer to not respond</option><option value="No">No</option><option value="Yes">Yes</option></select>'

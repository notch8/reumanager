jQuery ->
  ...
  mentor1Select = '<select id="applicant_mentor1" name="applicant[mentor1]"><option value="Jeff Bowman">Jeff Bowman</option><option value="Dimitri Deheyn">Dimitri Deheyn</option><option value="Falk Feddersen">Falk Feddersen</option><option value="Sarah Gille">Sarah Gille</option><option value="Vicki Grassian">Vicki Grassian</option><option value="Jennifer Haase">Jennifer Haase</option><option value="Paul Jensen">Paul Jensen</option><option value="Lisa Levin">Lisa Levin</option><option value="Dan Lubin">Dan Lubin</option><option value="Richard Norris">Richard Norris</option><option value="Brian Palenik">Brian Palenik</option><option value="Lynn Russell">Lynn Russell</option><option value="Brice Semmens">Brice Semmens</option><option value="Ana Sirovic">Ana Sirovic</option><option value="Dave Stegman">Dave Stegman</option><option value="Lynne Talley">Lynne Talley</option><option value="Lisa Tauxe">Lisa Tauxe</option><option value="Jennifer Taylor">Jennifer Taylor</option><option value="Jane Willenbring">Jane Willenbring</option><option value="Other">Other</option></select>'
  ...
  mentor1_input = (id) ->
    $(id).click( ->
      ...
      $('#mentor1Select_container').remove();
  ...
  mentor2Select = '<select id="applicant_mentor2" name="applicant[mentor2]"><option value="Jeff Bowman">Jeff Bowman</option><option value="Dimitri Deheyn">Dimitri Deheyn</option><option value="Falk Feddersen">Falk Feddersen</option><option value="Sarah Gille">Sarah Gille</option><option value="Vicki Grassian">Vicki Grassian</option><option value="Jennifer Haase">Jennifer Haase</option><option value="Paul Jensen">Paul Jensen</option><option value="Lisa Levin">Lisa Levin</option><option value="Dan Lubin">Dan Lubin</option><option value="Richard Norris">Richard Norris</option><option value="Brian Palenik">Brian Palenik</option><option value="Lynn Russell">Lynn Russell</option><option value="Brice Semmens">Brice Semmens</option><option value="Ana Sirovic">Ana Sirovic</option><option value="Dave Stegman">Dave Stegman</option><option value="Lynne Talley">Lynne Talley</option><option value="Lisa Tauxe">Lisa Tauxe</option><option value="Jennifer Taylor">Jennifer Taylor</option><option value="Jane Willenbring">Jane Willenbring</option><option value="Other">Other</option></select>'
  ...
  mentor3Select = '<select id="applicant_mentor3" name="applicant[mentor3]"><option value="Jeff Bowman">Jeff Bowman</option><option value="Dimitri Deheyn">Dimitri Deheyn</option><option value="Falk Feddersen">Falk Feddersen</option><option value="Sarah Gille">Sarah Gille</option><option value="Vicki Grassian">Vicki Grassian</option><option value="Jennifer Haase">Jennifer Haase</option><option value="Paul Jensen">Paul Jensen</option><option value="Lisa Levin">Lisa Levin</option><option value="Dan Lubin">Dan Lubin</option><option value="Richard Norris">Richard Norris</option><option value="Brian Palenik">Brian Palenik</option><option value="Lynn Russell">Lynn Russell</option><option value="Brice Semmens">Brice Semmens</option><option value="Ana Sirovic">Ana Sirovic</option><option value="Dave Stegman">Dave Stegman</option><option value="Lynne Talley">Lynne Talley</option><option value="Lisa Tauxe">Lisa Tauxe</option><option value="Jennifer Taylor">Jennifer Taylor</option><option value="Jane Willenbring">Jane Willenbring</option><option value="Other">Other</option></select>'

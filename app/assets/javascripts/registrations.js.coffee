jQuery ->
  ...
  mentor1Select = '<select id="applicant_mentor1" name="applicant[mentor1]" class="form-control"><option value="Andy Allen">Andy Allen</option><option value="Lihini Aluwihare">Lihini Aluwihare</option><option value="Doug Bartlett">Doug Bartlett</option><option value="Simone Baumann-Pickering">Simone Baumann-Pickering</option><option value="Jeff Bowman">Jeff Bowman</option><option value="Dimitri Deheyn">Dimitri Deheyn</option><option value="Jeff Gee">Jeff Gee</option><option value="Sarah Gille">Sarah Gille</option><option value="Vicki Grassian">Vicki Grassian</option><option value="John Hildebrand">John Hildebrand</option><option value="Ryan Hechinger">Ryan Hechinger</option><option value="Paul Jensen">Paul Jensen</option><option value="Lisa Levin">Lisa Levin</option><option value="Dan Lubin">Dan Lubin</option><option value="Deirdre Lyons">Deirdre Lyons</option><option value="Dick Norris">Dick Norris</option><option value="Brian Palenik">Brian Palenik</option><option value="Sarah Purkey">Sarah Purkey</option><option value="Lynn Russell">Lynn Russell</option><option value="Brice Semmens">Brice Semmens</option><option value="Dave Stegman">Dave Stegman</option><option value="Jennifer Taylor">Jennifer Taylor</option><option value="Joel Norris">Joel Norris</option><option value="Marty Ralph">Marty Ralph</option><option value="Ross Parnell-Turner">Ross Parnell-Turner</option><option value="Other">Other</option></select>'
